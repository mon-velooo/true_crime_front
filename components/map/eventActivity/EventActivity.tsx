...
import EventActivitySkeleton from "./EventActivitySkeleton";
...
const EventActivityContent = ({
  ...
  if (crimes.crimes.length === 0) return <EventActivitySkeleton />;
            ...
            <div
              ...
              className={cn(
                ...
                hoveredCrime?.id === crime.id
                  ? "bg-accent"
                  : "bg-card-secondary hover:bg-accent"
              )}
            ...
            >
              <div className="space-y-3">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <Badge
                    variant="secondary"
                    className={getLawCategoryColor(crime.lawCategory.label)}
                  >
