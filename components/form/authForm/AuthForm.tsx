  ...
  return (
    <div className="w-full min-h-screen lg:grid lg:grid-cols-2">
      <div className={`flex items-center justify-center py-12 ${orderClasses}`}>
        <div className="mx-auto grid w-[350px] gap-6">
          <div className="grid gap-2 text-center">
            ...
            <p className="mx-auto grid w-[300px] text-balance text-muted-foreground">{description}</p>
          </div>
      ...
      <div className="hidden bg-muted lg:block">
        <img src={image} alt="New york city" width="1920" height="1080" className="h-full w-full object-cover" />
      </div>
    </div>
  );
}
